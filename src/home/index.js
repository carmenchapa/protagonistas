...
const Rectangle = (props) => <div className="Centred" style={{backgroundColor: props.color, width: props.width, height: props.height, alignItems: 'flex-end'}}><img src={props.src} width={'100%'} height={'100%'} alt="" /></div>